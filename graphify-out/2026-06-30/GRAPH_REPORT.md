# Graph Report - schoolweb  (2026-06-30)

## Corpus Check
- 138 files · ~437,009 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 824 nodes · 1480 edges · 95 communities (45 shown, 50 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b350eb0`
...
Cohesion: 0.06
Nodes (33): navItems, Sidebar(), SidebarProps, MobileMenuProps, NavItem, NAV_ITEMS, Navbar(), authClient (+25 more)
...
Cohesion: 0.10
Nodes (19): getAllPages(), getPageBySlug(), changePassword(), createUser(), deleteUser(), getUserById(), getUsers(), requireAuth() (+11 more)

### Community 3 - "Achievements System"
Cohesion: 0.12
Nodes (29): getGalleries(), BreadcrumbLink, PageHeader(), PageHeaderProps, AkunBaruPage(), BeritaBaruPage(), FasilitasBaruPage(), GaleriBaruPage() (+21 more)
...
Cohesion: 0.09
Nodes (28): getPosts(), DeleteDialog(), DeleteDialogProps, EmptyState(), EmptyStateProps, Akun, AkunPage(), roleLabels (+20 more)
...
Cohesion: 0.27
Nodes (9): createPost(), deletePost(), getPostById(), getPostCount(), requireAuth(), updatePost(), posts, PostSchema (+1 more)
...
Cohesion: 0.08
Nodes (23): createContact(), deleteContact(), getContacts(), getUnreadCount(), markAllAsRead(), markAsRead(), requireAuth(), getFacilityCount() (+15 more)

## Knowledge Gaps
- **384 isolated node(s):** `__dirname`, `$schema`, `style`, `rsc`, `tsx` (+379 more)
...
- **Why does `cn()` connect `App Pages & Shared UI` to `Staff & Homepage Data`, `Content Pages & Galleries`, `Achievements System`, `Community 102`, `Facilities System`, `Community 73`, `Community 87`, `Community 88`, `Community 89`, `Community 94`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Achievements System` to `News System`, `Content Pages & Galleries`, `Community 102`, `Community 71`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Button()` connect `Achievements System` to `App Pages & Shared UI`, `Content Pages & Galleries`, `Community 102`, `Community 71`, `Facilities System`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
...
- **What connects `__dirname`, `$schema`, `style` to the rest of the system?**
