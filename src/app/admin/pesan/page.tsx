              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span
                      className={`text-sm ${m.isRead ? "text-muted-foreground" : "font-semibold text-card-foreground"}`}
                    >
                      {m.name}
                    </span>
                ...
                <div className="border-t border-border px-4 py-4 bg-muted/20 space-y-2">
                  <div className="grid sm:grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <span className="text-card-foreground">{m.email}</span>
                    </div>
                    {m.phone && (
                      <div>
                        <span className="text-muted-foreground">Telepon:</span>{" "}
                        <span className="text-card-foreground">{m.phone}</span>
                      </div>
                    )}
                    <div>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-destructive hover:text-destructive/80 pt-1 transition-colors"
                  >
                    <Trash2 className="h-3 w-3" /> Hapus Pesan
                  </button>
                </div>
              )}
            </div>
