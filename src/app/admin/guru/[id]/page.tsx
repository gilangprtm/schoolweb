      ...
      <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input defaultValue="Drs. Ahmad Fauzi, M.Pd." required />
          </div>
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              defaultValue="S2 Manajemen Pendidikan, UPI (2015)"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              rows={3}
              className="w-full rounded-lg border border-neutral-200 px-3 py-2 text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none"
              defaultValue="Beliau telah mengabdi selama lebih dari 15 tahun..."
            />
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input defaultValue="kepsek@sekolah.sch.id" />
            </div>
            <div className="space-y-2">
