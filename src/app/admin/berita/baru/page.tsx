...
export default function BeritaBaruPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    toast({ type: "success", title: "Berita disimpan", description: title || "Berita baru telah ditambahkan" })
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Tulis konten berita di sini... (akan menggunakan TipTap editor nantinya)"
            />
          </div>
        </div>
